      ...
      <section className="relative h-screen w-full overflow-hidden text-white">
        ...
        >
          ...
          <p className="mt-4 text-lg text-white/90 max-w-xl">
            No construimos. Dirigimos el sistema que hace posible la
            construcción. Reducimos conflictos, damos certeza al desarrollador,
            al contratista, al inversionista y al propietario. Somos la
            inteligencia técnica que transforma la experiencia en sistemas
            replicables, accesibles y al servicio de todos.
          </p>
          <a
            href="/contacto"
          ...
          >
            Solicita tu diagnóstico técnico gratuito
          </a>
        </motion.div>
      </section>
