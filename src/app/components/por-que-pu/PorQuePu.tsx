...
export default function SeccionModeloOperativo() {
  ...
  return (
    <>
      <section className="relative min-h-[80vh] flex flex-col justify-center items-center overflow-hidden px-6 md:px-16 lg:px-24 py-20 bg-transparent text-gray-600 dark:text-white">
        ...
        >
          ...
          <p className="text-lg md:text-xl mb-2">
            PU Consulting opera bajo un modelo fractal: cada célula es una micro-firma autónoma con roles claros que aseguran resultados inmediatos.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
            {items.map((item, index) => (
              ...
              >
                <div className="mb-3 text-blue-800 dark:text-blue-300">
                ...
                <p className="text-sm text-black dark:text-white/80 mt-1">
                  {item.description}
                </p>
              </div>
            ))}
